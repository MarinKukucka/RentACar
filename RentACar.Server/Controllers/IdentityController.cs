...
{
    public class IdentityController(UserManager<ApplicationUser> userManager, Application.Common.Interfaces.IEmailSender<ApplicationUser> emailSender, IMediator mediator) : ApiController
    {

...
namespace RentACar.Infrastructure.Migrations
{
    ...
    [Migration("20250530204231_AddAllMissingEntities")]
    partial class AddAllMissingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoicePayment", b =>
                {
                    ...
                    b.HasKey("InvoicesId", "PaymentsId");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ExtraService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.RentalPhoto", b =>
                {
                    ...
                    b.Property<int>("ReservationPhotoType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ReservationExtras", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ReservationPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoicePayment", b =>
                {
                    ...
                    b.HasOne("RentACar.Domain.Entities.Payment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RentACar.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("RentACar.Domain.Entities.Person", "Person")
                        .WithOne("User")
                        .HasForeignKey("RentACar.Domain.Entities.ApplicationUser", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("RentACar.Domain.Entities.Location", "ReturnLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("RentACar.Domain.Entities.ReservationExtras", b =>
                {
                    b.HasOne("RentACar.Domain.Entities.ExtraService", "ExtraService")
                        .WithMany()
